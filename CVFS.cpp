...
void man(char *name)
{
    ...
    {
        printf("Description : Used to open existinng file\n");
        printf("Usage : open File_Descriptor mode\n");
    }
...
int GetFDFromName(char *name)
{
    ...
    while(i < 50)
    {
        if(UFDTArr[50].ptrfiletable != NULL)
...
int fstat_file(int fd)
{
    ...
    if(UFDTArr[i].ptrfiletable == NULL) return -2;
